...
;
; OUTPUTS:
;       For usage without uncertainties:
;       Returns single variable: estimated mass
;
;       For usage with uncertainties:
;       Returns two-element array: [0]: estimated mass
;                                  [1]: uncertainty in mass
;
; EXAMPLES:
;       Usage without metallicity:
;
;       IDL> MTGRFUNC(9200.,3.90)
;
;
;       Usage without metallicity and with uncertainties:
;
;       IDL> MTGRFUNC(9200.,3.90,eteff=200.,elogg=0.15)
;
;
;       Usage with metallicity
;
;       IDL> MTGRFUNC(9200.,3.90,feh=0.12)
;
;
;       Usage with metallicity and uncertainties
;
;       IDL> MTGRFUNC(9200.,3.90,feh=0.12,eteff=200.,elogg=0.15,efeh=0.08)
;
;
;       Usage with metallicity, alpha abundance and uncertainties
;
;       IDL> MTGRFUNC(9200.,3.90,feh=0.12,alfe=0.2,eteff=200.,elogg=0.15,efeh=0.08,ealfe=0.1)
;
;
; RESTRICTIONS:
   ...
   ENDIF ELSE BEGIN
      ...
      ENDIF ELSE BEGIN
         ...
         ENDIF ELSE BEGIN
            ...
            IF dmte+dmlogg+dmfeh+dmalfe NE 0. THEN RETURN,[mass,dm] ELSE RETURN,mass
         ENDELSE
      ENDELSE
   ENDELSE
ENDELSE
